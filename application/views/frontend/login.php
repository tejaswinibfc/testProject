...
<body>
  ...
  <main>
    ...
    <section class="tp-login-area pb-140 p-relative z-index-1 fix">
      <div class="tp-login-shape">
        <img class="tp-login-shape-1" src="<?= base_url() ?>assets_front/img/login/login-shape-1.png" alt="">
        <img class="tp-login-shape-2" src="<?= base_url() ?>assets_front/img/login/login-shape-2.png" alt="">
        <img class="tp-login-shape-3" src="<?= base_url() ?>assets_front/img/login/login-shape-3.png" alt="">
        <img class="tp-login-shape-4" src="<?= base_url() ?>assets_front/img/login/login-shape-4.png" alt="">
      </div>
      <div class="container">
          ...
          <div class="col-xl-6 col-lg-8">
            <div class="tp-login-wrapper">
              <div class="tp-login-top text-center mb-30">
                <h3 class="tp-login-title">Login to User</h3>
                <p>Don’t have an account? <span><a href="<?= base_url() ?>Register">Create a free account</a></span></p>
              </div>
                ...
                <div class="tp-login-option">
                  <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                    <div class="tp-login-option-item has-google">
                      <a href="#">
                        <img src="<?= base_url() ?>assets_front/img/icon/login/google.svg" alt="">
                        Sign in with google
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="tp-login-input-wrapper">
                    ...
                    <div class="tp-login-input-box">
                      <div class="tp-login-input">
                        <input id="tp_password" type="password" name="password" placeholder="Enter password">
                      </div>
  ...
  <!-- JS here -->
  <script src="<?= base_url() ?>assets_front/js/vendor/jquery.js"></script>
  <script src="<?= base_url() ?>assets_front/js/vendor/waypoints.js"></script>
  <script src="<?= base_url() ?>assets_front/js/bootstrap-bundle.js"></script>
  <script src="<?= base_url() ?>assets_front/js/meanmenu.js"></script>
  <script src="<?= base_url() ?>assets_front/js/swiper-bundle.js"></script>
  <script src="<?= base_url() ?>assets_front/js/slick.js"></script>
  <script src="<?= base_url() ?>assets_front/js/range-slider.js"></script>
  <script src="<?= base_url() ?>assets_front/js/magnific-popup.js"></script>
  <script src="<?= base_url() ?>assets_front/js/nice-select.js"></script>
  <script src="<?= base_url() ?>assets_front/js/purecounter.js"></script>
  <script src="<?= base_url() ?>assets_front/js/countdown.js"></script>
  <script src="<?= base_url() ?>assets_front/js/wow.js"></script>
  <script src="<?= base_url() ?>assets_front/js/isotope-pkgd.js"></script>
  <script src="<?= base_url() ?>assets_front/js/imagesloaded-pkgd.js"></script>
  <script src="<?= base_url() ?>assets_front/js/ajax-form.js"></script>
