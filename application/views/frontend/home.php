            ...
            <div class="tp-product-category-item text-center mb-40">
              <div class="tp-product-category-thumb fix">
                <a href="shop-category.html">
                  <img src="<?= base_url('uploads/') . $value->cate_image ?>" alt="">
                </a>
              </div>
              <div class="tp-product-category-content">
                <h3 class="tp-product-category-title">
                  <a href="shop-category.html"><?= $value->cate_name ?></a>
                </h3>
              ...
              <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" aria-labelledby="new-tab" tabindex="0">
                <div class="row">
                  <?php foreach ($product as $key => $value) {
                    $category_name = $this->Home_model->category_name($value->category);
                  ?>
                      ...
                      <div class="tp-product-item p-relative transition-3 mb-25">
                        <div class="tp-product-thumb p-relative fix m-img">
                          <a href="<?= base_url("product/") . $value->slug ?>">
                            <img src="<?= base_url('uploads/') . $value->prod_main_image ?>" alt="">
                          </a>
                        ...
                        <div class="tp-product-content">
                          <div class="tp-product-category">
                            <a href="<?= base_url("product/") . $value->slug ?>"><?= $category_name ?></a>
                          </div>
                          ...
                          <div class="tp-product-price-wrapper">
                            <span class="tp-product-price old-price">Rs.<?= number_format($value->mrp, 2) ?></span>
                            <span class="tp-product-price new-price">Rs.<?= number_format($value->selling_price, 2) ?></span>
                          </div>
                        </div>
                      </div>
                    </div>
