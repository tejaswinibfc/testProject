    ...
    <div id="loading-center">
      <div id="loading-center-absolute">
        ...
        <div class="tp-preloader-content">
          ...
          <h3 class="tp-preloader-title">Shop</h3>
              ...
              <div class="tp-header-top-right d-flex align-items-center justify-content-end">
                <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                  ...
                  <div class="tp-header-top-menu-item tp-header-setting">
                    ...
                    <ul>
                      <li>
                        <a href="<?= base_url() ?>Home/">My Profile</a>
                      </li>
                      <li>
            ...
            <div class="col-xl-4 col-lg-3 col-md-8 col-6">
              <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                <div class="tp-header-login d-none d-lg-block">
                  <a href="<?= base_url() ?>Login" class="d-flex align-items-center">
                    ...
                    <div class="tp-header-login-content d-none d-xl-block">
                      <span>Hello , <?= $this->session->userdata('user_name') ?? 'User' ?></span>
                  ...
                  <nav class="tp-category-menu-content">
                    <ul>
                      <?php foreach ($category as $key => $value) {
                        $sub_cate  = $this->Home_model->all_subcategory($value->cate_id);
                        if ($sub_cate) { ?>
                          <li class="has-dropdown">
                            <a href="<?= $value->slug ?>" class="has-mega-menu">
                              <?= $value->cate_name ?></a>
                              ...
                              <li>
                                <ul>
                                  <?php foreach ($sub_cate as $key => $val) { ?>
                                    <li>
                                      <a href="<?= $val->slug ?>"><?= $val->cate_name ?></a>
                                    </li>
                                  <?php } ?>
                                </ul>
                              </li>
                ...
                <div class="main-menu menu-style-1">
                  <nav class="tp-main-menu-content">
                    <ul>
                      ...
                      <li><a href="<?= base_url() ?>Home/product-details">Product</a></li>
                      <li><a href="<?= base_url() ?>Home">Contact</a></li>
                    </ul>
                  </nav>
                </div>
              </div>
